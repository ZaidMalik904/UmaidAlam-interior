...
export interface GalleryItem {
  ...
  src: string;
  title: string;
  category: "Acoustics & Soundproofing" | "False Ceiling & Lighting" | "Woodwork & Paneling" | "Site Execution";
}

// All 47 images present in public/images/gallery (img1-img39, img41-img48)
const galleryItems: GalleryItem[] = [
  { id: 1, src: "/images/gallery/img1.jpeg", title: "Acoustic Wall Treatment", category: "Acoustics & Soundproofing" },
  ...
  { id: 4, src: "/images/gallery/img4.jpeg", title: "Gypsum False Ceiling", category: "False Ceiling & Lighting" },
  { id: 5, src: "/images/gallery/img5.jpeg", title: "Soundproof Studio Wall", category: "Acoustics & Soundproofing" },
  { id: 6, src: "/images/gallery/img6.jpeg", title: "Auditorium Acoustic Setup", category: "Acoustics & Soundproofing" },
  { id: 7, src: "/images/gallery/img7.jpeg", title: "Commercial False Ceiling", category: "False Ceiling & Lighting" },
  ...
  { id: 10, src: "/images/gallery/img10.jpeg", title: "Fabric Acoustic Paneling", category: "Acoustics & Soundproofing" },
  { id: 11, src: "/images/gallery/img11.jpeg", title: "Cove Lighting Ceiling", category: "False Ceiling & Lighting" },
  { id: 12, src: "/images/gallery/img12.jpeg", title: "Studio Sound Insulation", category: "Acoustics & Soundproofing" },
  { id: 13, src: "/images/gallery/img13.jpeg", title: "Wooden Slat Installation", category: "Woodwork & Paneling" },
  { id: 14, src: "/images/gallery/img14.jpeg", title: "Conference Room Acoustics", category: "Acoustics & Soundproofing" },
  { id: 15, src: "/images/gallery/img15.jpeg", title: "Site Framing & Carpentry", category: "Site Execution" },
  { id: 16, src: "/images/gallery/img16.jpeg", title: "Architectural Ceiling Grid", category: "False Ceiling & Lighting" },
  { id: 17, src: "/images/gallery/img17.jpeg", title: "Modular Soundproofing", category: "Acoustics & Soundproofing" },
  ...
  { id: 20, src: "/images/gallery/img20.jpeg", title: "Coffered Ceiling Design", category: "False Ceiling & Lighting" },
  { id: 21, src: "/images/gallery/img21.jpeg", title: "High-Density Soundproofing", category: "Acoustics & Soundproofing" },
  ...
  { id: 24, src: "/images/gallery/img24.jpeg", title: "Linear Baffle Ceiling", category: "False Ceiling & Lighting" },
  { id: 25, src: "/images/gallery/img25.jpeg", title: "Acoustic Seat Sealing", category: "Acoustics & Soundproofing" },
  ...
  { id: 28, src: "/images/gallery/img28.jpeg", title: "Modern Cove Ceiling", category: "False Ceiling & Lighting" },
  { id: 29, src: "/images/gallery/img29.jpeg", title: "Podcast Studio Wall", category: "Acoustics & Soundproofing" },
  ...
  { id: 32, src: "/images/gallery/img32.jpeg", title: "Acoustic Fabric Finish", category: "Acoustics & Soundproofing" },
  { id: 33, src: "/images/gallery/img33.jpeg", title: "Suspended Grid Ceiling", category: "False Ceiling & Lighting" },
  { id: 34, src: "/images/gallery/img34.jpeg", title: "Soundproof Door Paneling", category: "Acoustics & Soundproofing" },
  { id: 35, src: "/images/gallery/img35.jpeg", title: "Architectural Wood Slatting", category: "Woodwork & Paneling" },
  { id: 36, src: "/images/gallery/img36.jpeg", title: "Precision Gypsum Ceiling", category: "False Ceiling & Lighting" },
  { id: 37, src: "/images/gallery/img37.jpeg", title: "Sound Proofing Execution", category: "Acoustics & Soundproofing" },
  { id: 38, src: "/images/gallery/img38.jpeg", title: "On-Site Installation Team", category: "Site Execution" },
  { id: 39, src: "/images/gallery/img39.jpeg", title: "Decorative Acoustic Wall", category: "Acoustics & Soundproofing" },
  { id: 41, src: "/images/gallery/img41.jpeg", title: "Premium Ceiling Cove", category: "False Ceiling & Lighting" },
  { id: 42, src: "/images/gallery/img42.jpeg", title: "Acoustic Baffle System", category: "Acoustics & Soundproofing" },
  ...
  { id: 45, src: "/images/gallery/img45.jpeg", title: "Sound Insulation Paneling", category: "Acoustics & Soundproofing" },
  { id: 46, src: "/images/gallery/img46.jpeg", title: "Modern Gypsum Design", category: "False Ceiling & Lighting" },
    ...
    <section id="gallery" className="py-20 bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 bg-red-50 text-[#E8412C] text-xs font-extrabold uppercase tracking-widest px-3.5 py-1.5 rounded-full mb-3">
            <Sparkles className="w-3.5 h-3.5" />
            <span>PROJECT GALLERY</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0B2A4A] font-heading mt-1 mb-3">
            Real Site Execution Gallery
          </h2>
          <p className="text-base text-[#4A5568] leading-relaxed">
            Browse authentic site photos of our acoustic paneling, soundproofing, gypsum false ceilings, and woodwork completed across Noida & NCR.
          </p>
        </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs sm:text-sm font-bold transition-all duration-200 flex items-center gap-2 ${
                  isActive
                    ...
                    : "bg-gray-100 text-[#4A5568] hover:bg-gray-200 hover:text-[#0B2A4A]"
                }`}
              >
                <span>{cat}</span>
                <span
                  className={`text-[10px] px-1.5 py-0.5 rounded-full ${
                    isActive ? "bg-[#E8412C] text-white" : "bg-gray-200 text-gray-600"
                  }`}
                >
                  {count}
                </span>
        ...
        {/* Gallery Image Grid - 4 Cards per Row with Increased Height & Width */}
      ...
      {lightboxIndex !== null && filteredItems[lightboxIndex] && (
        ...
        >
          ...
          <button
            ...
            className="absolute top-5 right-5 z-20 p-3 rounded-full bg-white/10 hover:bg-white/20 text-white backdrop-blur-md transition-all focus:outline-none"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          <button
            ...
            className="absolute left-3 sm:left-6 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/10 hover:bg-white/25 text-white backdrop-blur-md transition-all focus:outline-none"
          >
          ...
          <button
            ...
            className="absolute right-3 sm:right-6 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/10 hover:bg-white/25 text-white backdrop-blur-md transition-all focus:outline-none"
          >
